...
angular.module('pruebaApp')
  ...
  .controller('RenderCtrl', ['$scope',function($scope) {
    ...
    var camera, scene, renderer,rendererR,  svgRenderer, renderercube, vectorcubo, cubo, geometry, material;
    ...
    function init() {
      ...
      rendererR.domElement.style.margin = '0px 0px 0px -500px';
      ...
      document.getElementById( 'container' ).appendChild( svgRenderer.domElement );
    ...
    function addData(howMany){
      ...
      for ( var i = indexPointer; i < indexPointer + howMany; i += 1 ) {
        ...
        objectX.position.x = Math.random() * 4000 - 2000;
        objectX.position.y = Math.random() * 4000 - 2000;
        objectX.position.z = Math.random() * 4000 - 2000;
