  ...
  .controller('RenderController', ['$scope',function($scope) {
    ...
    function addData(howMany){
      ...
      for ( var i = indexPointer; i < indexPointer + howMany; i += 1 ) {
        ...
        //var svgmin = document.createElement('svg');
        //grafico.className = 'vectorGraf';
        //grafico.appendChild(svgmin);
        ...
        var leyenda = document.createElement('leyenda');
        leyenda.className = 'leyenda';
        leyenda.innerHTML =
          '<b>Ingresos </b></br>'+
          '<b>Pagos </b></br>' +
          '<b>Tarjetas </b>'
        element.appendChild(leyenda);
