...
[![Build Status](https://travis-ci.org//test-project.svg?branch=master)](https://travis-ci.org//test-project) [![Dependency Status](https://david-dm.org//test-project.svg)](https://david-dm.org//test-project) [![devDependency Status](https://david-dm.org//test-project/dev-status.svg)](https://david-dm.org//test-project#info=devDependencies)
