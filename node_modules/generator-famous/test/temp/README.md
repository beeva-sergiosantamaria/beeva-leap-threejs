...
[![Build Status](https://travis-ci.org//temp.svg?branch=master)](https://travis-ci.org//temp) [![Dependency Status](https://david-dm.org//temp.svg)](https://david-dm.org//temp) [![devDependency Status](https://david-dm.org//temp/dev-status.svg)](https://david-dm.org//temp#info=devDependencies)
